...
export DB_PATCH_PKG=${DB_PATCH_PKG:-"p29834717_190000_Linux-x86-64.zip"}
export DB_OJVM_PKG=${DB_OJVM_PKG:-"p29774421_190000_Linux-x86-64.zip"}
...
export ORACLE_HOME_NAME=${ORACLE_HOME_NAME:-"19.4.0.0"}
