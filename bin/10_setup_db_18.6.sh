...
export DB_PATCH_PKG=${DB_PATCH_PKG:-"p29301631_180000_Linux-x86-64.zip"}
export DB_OJVM_PKG=${DB_OJVM_PKG:-"p29249584_180000_Linux-x86-64.zip"}
...
export ORACLE_HOME_NAME=${ORACLE_HOME_NAME:-"18.6.0.0"}
