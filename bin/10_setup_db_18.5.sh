...
# ---------------------------------------------------------------------------
# Name.......: 10_setup_db_18.5.sh
# Author.....: Stefan Oehrli (oes) stefan.oehrli@trivadis.com
# Editor.....: Stefan Oehrli
# Date.......: 2019.01.17
# Revision...: 
# Purpose....: wrapper script to install Oracle 18.5 databases binaries
...
export DB_PATCH_PKG=${DB_PATCH_PKG:-"p28790647_180000_Linux-x86-64.zip"}
export DB_OJVM_PKG=${DB_OJVM_PKG:-"p28790647_180000_Linux-x86-64.zip"}
...
export ORACLE_HOME_NAME=${ORACLE_HOME_NAME:-"18.5.0.0"}
